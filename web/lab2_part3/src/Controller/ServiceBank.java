...
public class ServiceBank {
     ...
     * @param sign +/-
     */
    public static void changeAmountMoney(Bank bank, int sign, String numberAccount, int money) {
        for (AccountAbstract account: bank.getListOfAccounts()) {
            if (account.getAccountNumber().equals(numberAccount)){
                if (account.isBlocked()){
                    ...
                    account.setMoneyAmount(account.getMoneyAmount() + sign*money);
                    break;
                }
            }
        }
     ...
     * @return accounts
     */
    public static ArrayList<AccountAbstract> unblock(Bank bank, String numberAccount) {
        for (AccountAbstract account: bank.getListOfAccounts()) {
            if (account.getAccountNumber().equals(numberAccount)) {
     ...
     * @return accounts
     */
    public static ArrayList<AccountAbstract> block(Bank bank, String numberAccount) {
        for (AccountAbstract account: bank.getListOfAccounts()) {
            if (account.getAccountNumber().equals(numberAccount)) {
