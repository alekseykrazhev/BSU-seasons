...
public class WorkPlanDAO implements DAO<WorkPlan> {
    ...
    public List<WorkPlan> getAll() throws DAOException, SQLException, ConnectionPoolException {
        ...
        try {
            ...
            CriteriaQuery<WorkPlan> criteriaQuery = criteriaBuilder.createQuery(WorkPlan.class);
            Root<WorkPlan> rootClient = criteriaQuery.from(WorkPlan.class);
    ...
    public void insert(WorkPlan workPlan, int id) throws DAOException, SQLException, ConnectionPoolException {
        ...
        try {
            ...
            // CriteriaBuilder criteriaBuilder = entityManager.getCriteriaBuilder();
            // CriteriaUpdate<WorkPlan> update = criteriaBuilder.createCriteriaUpdate(WorkPlan.class);
            // Root<WorkPlan> rootBook = update.from(WorkPlan.class);
            // update.set(rootBook.get(WorkPlan_.ID), workPlan.id);
            // Predicate condition = criteriaBuilder.equal(rootBook.get(WorkPlan_.ID), id);
